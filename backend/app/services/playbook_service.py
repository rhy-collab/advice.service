...
from app.schemas.playbook import Playbook, PlaybookCheck, PlaybookCheckCreate, PlaybookCreate
...
class PlaybookService:
    ...
    def list_playbooks(self, contract_type: str | None = None) -> list[Playbook]:
        with self._session_factory() as db:
